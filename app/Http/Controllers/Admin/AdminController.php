...
//        dd($dthama,count($dtair),$dtapotek);
        ...
        return view('admin.dashboard', compact('dtapotek', 'dthama', 'dtair', 'dtsub', 'dtuser', 'c_apotik','c_air', 'c_hama', 'feedback', 'feedback_t', 'member', 'notif'));
    }
...
//        dd($dthama,count($dtair),$dtapotek);
        ...
        return view('auth.admin.settings', compact('dtapotek', 'dthama', 'dtair', 'dtsub', 'dtuser','c_apotik', 'ro', 'c_air', 'c_hama', 'feedback', 'feedback_t', 'member', 'notif', 'admins', 'admin'));
    }
