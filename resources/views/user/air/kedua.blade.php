                ...
                <div class="row animate-box">
                    ...
                    <div class="col-lg-12">
                        <nav>
                            <ol class="cd-multi-steps text-bottom count">
                                ...
                                <li class="current"><a href="#2">Identitas Depo</a></li>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="w3-panel w3-card">
                            <h2 style="padding-top: 5%" class="text-center">Identitas Depo Air Minum</h2>
                            <form action="{{route('depot.save.kedua')}}" method="post" class="form-horizontal">
                                {{ csrf_field() }}
                                <div class="row form-group">
                                    <div class="col-lg-12">
                                        <input placeholder="Nama depo" class="form-control" type="text"
