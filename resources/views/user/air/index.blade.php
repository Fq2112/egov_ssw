        ...
        <div class="container">
            <div class="row animate-box">
                ...
                <div class="col-lg-6" style="margin-bottom: 3em">
                    ...
                    @else
                        <a href="{{route('depot.data.pemohon')}}">
            ...
            <div class="row">
                ...
                <div class="tab-content" style="margin-top: 1em">
                    <div id="persyaratan" class="tab-pane fade in active">
                        ...
                        <ol>
                            <li>Surat Permohonan (bermaterai 6000) dilengkapi dengan nomor dan tanggal permohonan</li>
                            <li>Kartu Tanda Penduduk (KTP) Pemohon (untuk penduduk luar Surabaya)</li>
                            <li>Surat Pernyataan dari pemohon tentang lokasi usaha perusahaan</li>
                            <li>Denah dan luas bangunan dan ukuran</li>
                            <li>Gambar system kerja peralatan pengelolaan air minum dilengkapi dengan spesifikasi</li>
                            <li>Fotocopi surat izin pengambilan air baku dilengkapi dengan kontak person dan nomor telepon yang bisa dihubungi</li>
                            <li>Surat penyataan tunduk dan taat untuk memenuhi ketentuan dan peraturan perundang-undangan yang berlaku</li>
                            <li>Surat pernyataan bersedia dilakukan pemeriksaan dan pengujian kualitas air minum</li>
                            <li>Pengambilan langsung contoh spesimen oleh tim perizinan dan biaya sepenuhnya ditanggung permohon</li>
                            <li>Fotocopi perizinan lain yang dimiliki yang terkait dengan usaha</li>
                            <li>Pas Photo digital terbaru ukuran (3x4 cm)</li>
                        </ol>
                    </div>
                    <div id="prosedur" class="tab-pane fade text-center">
                        <img style="display: block; margin: auto;" class="img-responsive" src="{{asset('images/flowchart/flowchart_air.png')}}">
                    </div>
