...
<div id="jadi-data">
    <form action="{{route('hama.save.pertama')}}" method="post" class="form-horizontal" data-toggle="validator">
        {{ csrf_field() }}
        ...
        <span>Nomor Izin Sertifikasi Laik Hygiene Sanitasi</span>
        <input type="text" id="no_Hygiene" name="no_Hygiene"><br>
        <span>        tempat pengambilan sk
</span>
        <select name="tempat_sk" >
            <option value="0" disabled selected>--Pilih--</option>
