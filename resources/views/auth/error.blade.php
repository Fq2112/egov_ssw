...
<html>
<head>
    <title>SSWS - 404 Error Page</title>
    <meta name="keywords"
...
<div class="wrap">
    ...
    <div class="content">
        <img src="{{asset('images/error/error-img.png')}}" title="error"/>
        <p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
        <a href="{{route('login')}}">Back To Login Page</a>
        <div class="copy-right">
            <p>&#169 All rights Reserved | Designed by <a href="http://rabbit-media.net/">Rabbit Media</a></p>
        </div>
    </div>
</div>
</body>
