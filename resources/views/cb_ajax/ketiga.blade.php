                ...
                <div class="row animate-box">
                    ...
                    <div class="col-lg-12">
                        <nav>
                            <ol class="cd-multi-steps text-bottom count">
                                ...
                                <li class="current"><a href="#3">Identitas Pemilik</a></li>
                                <li><a href="#4">Daftar Alat</a></li>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="w3-panel w3-card">
                            <h2 style="padding-top: 5%" class="text-center">Identitas Pemilik</h2>
                            <div id="cek-data">
                            ...
                            <div id="jadi-data">
                                <form action="{{route('save.ketiga')}}" method="post" class="form-horizontal"
                                      data-toggle="validator">
                                    {{ csrf_field() }}  {{ method_field('post') }}
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-6">
                                            ...
                                            <input placeholder="Nama pemilik" class="form-control" type="text"
                                                   id="name" name="name" required>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="tgl">
                                                <input id="status" name="asd" type="checkbox"> Status Menggunakan Sarana
                                                <span style="font-size: 33px;" data-on="Pemilik"
                                                      data-off="Lainnya"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-6">
                                            <input placeholder="Pekerjaan" class="form-control" type="text"
                                                   name="pekerjaan" id="pekerjaan"
                                                   value="{{\Illuminate\Support\Facades\Auth::user()->pekerjaan}}"
                                                   required>
                                        </div>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-12">
                                            <input placeholder="Nomor NPWP" class="form-control" type="text"
                                                   name="npwp" id="npwp" maxlength="15" onkeypress="return
                                                       hanyaAngka(event, false)" required>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-lg-12">
