                ...
                <div class="row animate-box">
                    ...
                    <div class="col-lg-12">
                        <nav>
                            <ol class="cd-multi-steps text-bottom count">
                                ...
                                <li class="current"><a href="#2">Identitas Apotek</a></li>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="w3-panel w3-card">
                            <h2 style="padding-top: 5%" class="text-center">Identitas Apotek</h2>
                            <form action="{{route('save.kedua')}}" method="post" class="form-horizontal">
                                {{ csrf_field() }}
                                <div class="row form-group">
                                    <div class="col-lg-12">
                                        <input placeholder="Nama apotek" class="form-control" type="text"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(document).validator().on('change', '#provinsi', function () {
